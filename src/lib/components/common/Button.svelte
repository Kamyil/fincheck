<script module lang="ts">
    export let variants = {
        primary: "text-white from-primary_lighter to-primary hover:shadow-gray-300 focus-visible:ring-primary",
        ...
        green: "text-white from-green-500 to-green-700 hover:shadow-green-600 focus-visible:ring-green-600",
        green_outline: "text-green-500 border-1 border-green-500 hover:bg-green-500 hover:text-white focus-visible:ring-green-500",
        red: "text-white from-red-500 to-red-700 hover:shadow-red-600 focus-visible:ring-red-600",
        red_outline: "text-red-500 border-1 border-red-500 hover:bg-red-500 hover:text-white focus-visible:ring-red-500",
        orange: "text-white from-orange-500 to-orange-700 focus-visible:ring-orange-600",
        transparent: "bg-transparent border-none text-primary hover:shadow-none focus-visible:ring-primary",
    } as const;
...
<button
    ...
    {...rest}
>
    <div class="flex items-center justify-center transition-opacity" class:invisible={isLoading} class:opacity-50={isLoading} class:blur-sm={isLoading} class:scale-95={isLoading}>
    ...
    {#if isLoading}
        <div class="absolute inset-0 flex items-center justify-center bg-black/10" transition:fade={{ duration: 100 }} aria-label="Loading" role="status">
