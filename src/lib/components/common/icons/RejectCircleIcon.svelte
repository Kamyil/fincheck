<script lang="ts">
    ...
    let { xMarkClasses = "", circleClasses = "" }: Props = $props();
</script>

<div
    class="flex h-6 w-6 items-center justify-center rounded-full bg-red-700 shadow-md {circleClasses}"
>
    <svg
